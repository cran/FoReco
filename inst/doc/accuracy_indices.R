...
df <- cbind(col1 = c("$\\textbf{m}$","$\\textbf{1}$","$\\text{RelA}^{[m],1}_{1,j}$","$\\vdots$",
            ...
            col5 = c("", "$\\mathbf{M_k}$","$\\text{RelA}^{[k],M_k}_{1,j}$","$\\vdots$",
                         "$\\text{RelA}^{[k],M_k}_{i,j}$","$\\vdots$","$\\text{RelA}^{[k],M_k}_{n,j}$"),
...
df <- cbind(col1 = c("$\\textbf{m}$","$\\text{RelA}^{[m]}_{1,j}$","$\\vdots$",
                         "$\\text{RelA}^{[m]}_{i,j}$","$\\vdots$","$\\text{RelA}^{[m]}_{n,j}$"),
            col2 = c("$\\dots$","$\\dots$","","$\\dots$","","$\\dots$"),
            col3 = c("$\\textbf{k}$", "$\\text{RelA}^{[k]}_{1,j}$","$\\vdots$",
                         "$\\text{RelA}^{[k]}_{i,j}$","$\\vdots$","$\\text{RelA}^{[k]}_{n,j}$"),
            col4 = c("$\\dots$","$\\dots$","","$\\dots$","","$\\dots$"),
            col5 = c("$\\textbf{1}$","$\\text{RelA}^{[1]}_{1,j}$","$\\vdots$",
                         "$\\text{RelA}^{[1]}_{i,j}$","$\\vdots$","$\\text{RelA}^{[1]}_{n,j}$"),
            col6 = c("$\\dots$","$\\dots$","","$\\dots$","","$\\dots$"),
            col7 = c("$\\mathbf{all}$","$\\text{RelA}_{1,j}$","$\\vdots$",
                         "$\\text{RelA}_{i,j}$","$\\vdots$","$\\text{RelA}_{n,j}$"))
...
df <- cbind(col1 = c("$\\textbf{m}$","$\\textbf{1}$","$\\text{RelA}^{[m],1}_{j}$",
                         "$\\text{RelA}^{[m],1}_{a,j}$","$\\text{RelA}^{[m],1}_{b,j}$"),
            col2 = c("$\\dots$","$\\dots$","$\\dots$","$\\dots$","$\\dots$"),
            col3 = c("", "$\\textbf{1}$","$\\text{RelA}^{[k],1}_{j}$",
                         "$\\text{RelA}^{[k],1}_{a,j}$","$\\text{RelA}^{[k],1}_{b,j}$"),
            col4 = c("$\\textbf{k}$","$\\dots$","$\\dots$","$\\dots$","$\\dots$"),
            col5 = c("", "$\\mathbf{M_k}$","$\\text{RelA}^{[k],M_k}_{j}$",
                         "$\\text{RelA}^{[k],M_k}_{a,j}$","$\\text{RelA}^{[k],M_k}_{b,j}$"),
            col6 = c("$\\dots$","$\\dots$","$\\dots$","$\\dots$","$\\dots$"),
            col7 = c("", "$\\textbf{1}$","$\\text{RelA}^{[1],1}_{j}$",
                         "$\\text{RelA}^{[1],1}_{a,j}$","$\\text{RelA}^{[1],1}_{b,j}$"),
            col8 = c("$\\textbf{1}$","$\\dots$","$\\dots$","$\\dots$","$\\dots$"),
            col9 = c("", "$\\mathbf{m}$","$\\text{RelA}^{[1],m}_{j}$",
                         "$\\text{RelA}^{[1],m}_{a,j}$","$\\text{RelA}^{[1],m}_{b,j}$"))
